...
<div class="flex-1 flex flex-col overflow-hidden">
    ...
    <div class="h-16 px-6 sticky top-0 z-40 bg-surface/80 backdrop-blur-md border-b border-outline-variant flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-on-surface-variant mt-1">Opção {{ $sector->keyboard_option }} do pré-atendimento IVR</p>
        </div>
        ...
        <div class="max-w-4xl space-y-6">
            ...
            <div class="bg-white rounded-xl border border-outline-variant shadow-sm p-6">
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <!-- Keyboard Option -->
                    <div>
                        <p class="text-xs text-on-surface-variant font-semibold mb-1">Opção do Teclado</p>
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium {{ $sector->is_active ? 'bg-secondary-container/20 text-secondary' : 'bg-outline-variant/20 text-on-surface-variant' }}">
                ...
                <div class="mb-6">
                    <p class="text-xs text-on-surface-variant font-semibold mb-2">Descrição</p>
                ...
                <!-- Greeting Message -->
                <div>
                    <p class="text-xs text-on-surface-variant font-semibold mb-2">Mensagem de Boas-vindas</p>
                    <div class="p-3 bg-surface-container rounded-lg text-sm text-on-surface">
            ...
            <div class="bg-white rounded-xl border border-outline-variant shadow-sm p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium bg-surface-container-low text-on-surface-variant">
                ...
                <div class="text-center py-8">
                    <span class="material-symbols-outlined text-4xl text-on-surface-variant mb-2">people_outline</span>
                    <p class="text-on-surface-variant text-sm">Nenhum atendente neste setor</p>
                </div>
                @endif
            </div>
