...
<div class="flex-1 flex flex-col overflow-hidden">
    ...
    <div class="h-16 px-6 sticky top-0 z-40 bg-surface/80 backdrop-blur-md border-b border-outline-variant flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-on-surface-variant mt-1">Crie uma nova conta de atendente</p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl border border-outline-variant shadow-sm p-6">
                ...
                <form action="{{ route('admin.agents.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full border border-outline-variant rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-secondary focus:border-secondary {{ $errors->has('name') ? 'border-error' : '' }}" placeholder="Digite o nome completo" required>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="w-full border border-outline-variant rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-secondary focus:border-secondary {{ $errors->has('email') ? 'border-error' : '' }}" placeholder="Digite o email" required>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="w-full border border-outline-variant rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-secondary focus:border-secondary {{ $errors->has('password') ? 'border-error' : '' }}" placeholder="Mínimo 8 caracteres" required>
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" class="w-full border border-outline-variant rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-secondary focus:border-secondary" placeholder="Repita a senha" required>
