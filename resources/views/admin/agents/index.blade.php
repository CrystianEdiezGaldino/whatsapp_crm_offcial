...
<div class="flex-1 flex flex-col overflow-hidden">
    ...
    <div class="h-16 px-6 sticky top-0 z-40 bg-surface/80 backdrop-blur-md border-b border-outline-variant flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-on-surface-variant mt-1">Gerencie os atendentes do sistema</p>
        </div>
        ...
        <div class="max-w-7xl">
            ...
            <div class="bg-white rounded-xl border border-outline-variant shadow-sm p-6">
                ...
                <div class="text-center py-12">
                    <span class="material-symbols-outlined text-6xl text-on-surface-variant mb-4">person_add</span>
                    <p class="text-on-surface-variant text-lg mb-4">Nenhum atendente cadastrado</p>
