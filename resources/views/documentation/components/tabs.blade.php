...
<div class="min-h-screen bg-background">
    <div class="max-w-4xl mx-auto px-4 py-12">
        <div class="mb-12">
            ...
            <h1 class="text-4xl font-bold text-on-surface mb-4">tabs.Value.ToUpper()abs Component</h1>
            <p class="text-lg text-on-surface-variant">Tabbed interface</p>
        </div>

        <section class="mb-12">
            <h2 class="text-2xl font-bold text-on-surface mb-6">Documentation</h2>
            <x-card>
                <p class="text-on-surface-variant">Detailed documentation for the tabs component coming soon.</p>
