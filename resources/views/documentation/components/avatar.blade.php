...
<div class="min-h-screen bg-background">
    <div class="max-w-4xl mx-auto px-4 py-12">
        ...
        <div class="mb-12">
            ...
            <p class="text-lg text-gray-600">A reusable avatar component for displaying user profiles with optional status indicators.</p>
        </div>
        ...
        <section class="mb-12">
            ...
            <x-card title="Basic Avatars">
                <div class="flex gap-8 items-center flex-wrap">
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Small</p>
                        <x-avatar size="sm" name="John" />
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Medium</p>
                        <x-avatar size="md" name="Jane" />
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Large</p>
                        <x-avatar size="lg" name="Bob" />
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Extra Large</p>
            ...
            <x-card title="Avatar with Status Indicators" class="mt-6">
                <div class="flex gap-8 items-center flex-wrap">
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Online</p>
                        <x-avatar name="John" status="online" />
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Offline</p>
                        <x-avatar name="Jane" status="offline" />
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Away</p>
                        <x-avatar name="Bob" status="away" />
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-gray-600 mb-3">Busy</p>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-outline-variant">
                            <tr>
                                ...
                                <td class="px-4 py-3 text-gray-600">Image URL for the avatar</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-3 font-mono text-secondary">name</td>
                                <td class="px-4 py-3 text-gray-600">string</td>
                                <td class="px-4 py-3 text-gray-600">null</td>
                                <td class="px-4 py-3 text-gray-600">User name (shown on hover, first letter used as fallback)</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-3 font-mono text-secondary">size</td>
                                <td class="px-4 py-3 text-gray-600">string</td>
                                <td class="px-4 py-3 text-gray-600">'md'</td>
                                <td class="px-4 py-3 text-gray-600">Size variant: sm, md, lg, xl</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-3 font-mono text-secondary">status</td>
                                <td class="px-4 py-3 text-gray-600">string</td>
                                <td class="px-4 py-3 text-gray-600">null</td>
                                <td class="px-4 py-3 text-gray-600">Status indicator: online, offline, away, busy</td>
                            </tr>
                            <tr>
        ...
        <section class="mb-12">
            ...
            <x-card title="Basic Avatar" subtitle="Display user initials" class="mb-6">
                <pre class="bg-gray-100 p-4 rounded-lg overflow-x-auto text-sm"><code>&lt;x-avatar name="John Doe" /&gt;</code></pre>
            </x-card>

            <x-card title="Avatar with Image" subtitle="Display user photo" class="mb-6">
                <pre class="bg-gray-100 p-4 rounded-lg overflow-x-auto text-sm"><code>&lt;x-avatar
    name="John Doe"
...
/&gt;</code></pre>
            ...
            <x-card title="Avatar Sizes" subtitle="Different size variants">
                <pre class="bg-gray-100 p-4 rounded-lg overflow-x-auto text-sm"><code>&lt;x-avatar name="John" size="sm" /&gt;
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Customer Support Agent</p>
